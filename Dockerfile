...
# Ripgrep, exa, and fd
RUN wget --quiet https://github.com/BurntSushi/ripgrep/releases/download/0.9.0/ripgrep-0.9.0-x86_64-unknown-linux-musl.tar.gz -O $HOME/ripgrep.tar.gz && \
    ...
    \
    wget --quiet https://github.com/sharkdp/fd/releases/download/v7.1.0/fd-v7.1.0-x86_64-unknown-linux-musl.tar.gz -O $HOME/fd.tar.gz && \
