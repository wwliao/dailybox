...
RUN apt-get update && \
    ...
    htop parallel ncdu build-essential zlib1g zlib1g-dev gdb \
    libnss-sss && \
    apt-get clean && rm -rf /var/lib/apt/lists/*
...
# Miniconda3
RUN wget --quiet https://repo.anaconda.com/miniconda/Miniconda3-py38_4.8.3-Linux-x86_64.sh -O $HOME/miniconda.sh && \
